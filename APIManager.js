...
class APIManager {
    ...
    callApis(){
        ...
        $.get("https://randomuser.me/api/1.3/?results=6&inc=name",(friendsData) => this.data.friends = friendsData);
        $.get("https://randomuser.me/api/1.3/?inc=name,picture,location",(userData) => this.data.user = userData);
